package com.capco.weatherapp.api.geocode;
...
public class GeocodeCallRunnable extends ApiCallRunnable {
    private static final String TAG = "GeocodeCall";
    private static final String API = "https://maps.googleapis.com/maps/api/geocode/json?latlng=%1$f,%2$f&key=%3$s";
    private URL url;
    public GeocodeCallRunnable(LatLng point, String apiKey){
